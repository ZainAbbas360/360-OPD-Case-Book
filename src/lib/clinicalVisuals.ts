...
const visuals: Record<string, ClinicalVisual> = {
  ...
  'Vitamin D Deficiency Rickets': {
    ...
    sourceLabel: 'Wikimedia Commons — reusable teaching image',
    sourceUrl: commonsPage('RicketsXray.jpg'),
  },
  'Polycystic Ovary Syndrome (PCOS)': {
    image: commons('PCOS.jpg'),
    caption: 'Transvaginal ultrasound appearance of a polyfollicular ovary. Ultrasound can support the diagnosis, but ovarian morphology alone is not sufficient for diagnosis.',
  ...
  'Acute Appendicitis': {
    ...
    caption: 'Axial CT demonstrating an enlarged inflamed appendix. Key CT features include diameter over 6 mm, wall thickening or enhancement and periappendiceal fat stranding.',
  ...
  'Renal Colic (Urolithiasis)': {
    ...
    caption: 'Non-contrast CT showing a ureteric calculus with upstream obstruction. Look for the calculus, hydroureter or hydronephrosis and secondary inflammatory change.',
    sourceLabel: 'James Heilman, MD / Wikimedia Commons',
    sourceUrl: commonsPage('KidneyStone.JPG'),
  },
  'Measles': {
    image: commons('Photo of childhood rash obtained from measles.jpg'),
    caption: 'Typical measles exanthem: a confluent erythematous maculopapular rash appearing after the prodrome and spreading from the face and head downward.',
    sourceLabel: 'CDC / Wikimedia Commons — public domain',
    sourceUrl: commonsPage('Photo of childhood rash obtained from measles.jpg'),
  },
  'Uterine Fibroids': {
    image: commons('9cmFibroidUS.png'),
    caption: 'Ultrasound example of a uterine leiomyoma. Assess number, size and location because submucosal, intramural and subserosal fibroids can present differently.',
  ...
  'Diabetic Foot Ulcer': {
    ...
    caption: 'Clinical example of diabetic foot ulceration. Document site, size, depth, surrounding infection, perfusion and neuropathy; assess for deep infection when indicated.',
    sourceLabel: 'Wikimedia Commons — CC BY-SA',
  ...
  'Breast Lump (Fibroadenoma / Ca Screening)': {
    image: commons('Breast US Fibroadenoma 0531092019656 Nevit.jpg'),
    caption: 'Breast ultrasound demonstrating a fibroadenoma. Typical benign features include an oval, circumscribed, wider-than-tall hypoechoic lesion; suspicious or discordant findings need further assessment.',
    sourceLabel: 'Nevit Dilmen / Wikimedia Commons — CC BY-SA 3.0',
    sourceUrl: commonsPage('Breast US Fibroadenoma 0531092019656 Nevit.jpg'),
  },
  'Cellulitis': {
    image: commons('Cellulitis (of right leg).jpg'),
    caption: 'Clinical appearance of lower-limb cellulitis with diffuse erythema and swelling. Mark the edge when useful and reassess spread, systemic features and signs of deeper infection.',
    sourceLabel: 'S.M. Samee / Wikimedia Commons — CC BY-SA 4.0',
    sourceUrl: commonsPage('Cellulitis (of right leg).jpg'),
  },
  'Haemorrhoids (Piles)': {
    image: commons('Hemorrhoids.png'),
    caption: 'Illustration of haemorrhoidal disease. Use the visual to distinguish the anatomic concept of internal versus external disease; grading and symptoms guide management.',
    sourceLabel: 'BruceBlaus / Wikimedia Commons — CC BY-SA 4.0',
    sourceUrl: commonsPage('Hemorrhoids.png'),
  },
};
